...
function Footer() {
  return (
        <div className="text-center">
         ...
         <p className="justify-content-center" id="copyright"><a href="https://creativecommons.org/licenses/by-nc/4.0/">🄯 </a><a href="https://codeswitchstudio.com/">codeswitchstudio 2024</a> </p>
