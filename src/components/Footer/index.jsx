...
function Footer() {
  return (
        <div className="text-center">
         <footer className="py-3 my-4 footer-basic bg-tertiary">
         <p className="justify-content-center"><a href="https://creativecommons.org/licenses/by-nc/4.0/">🄯</a> Indira Endaya 2024</p>
